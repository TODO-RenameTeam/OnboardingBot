...
public class StepEntity
{
    ...
    public HashSet<RoleOnboardingEntity>? RoleOnboardings { get; set; } = new();
    public HashSet<RoleOnboardingStepEntity>? RoleOnboardingPositions { get; set; } = new();
}